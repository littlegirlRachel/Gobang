...
namespace k子棋
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            if (textBox1.ForeColor == Color.Black) return;  // 如果已经编辑过了则无需执行下列代码
        ...
        {
            if (textBox2.ForeColor == Color.Black) return;
        ...
        private void button1_Click(object sender, EventArgs e)  // 开始游戏按钮
        {
